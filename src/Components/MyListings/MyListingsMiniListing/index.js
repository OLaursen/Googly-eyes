...
import { Box, Button, Card, CardActions, CardContent, CardMedia, Container, Divider, Grid, Modal, TextField, Typography, styled } from "@mui/material";
            ...
            <Card >
                ...
                <CardActions>
                    <Grid container direction="row" justifyContent={"space-between"}>
                        ...
                        <Button size="small" variant="contained" color="secondary" onClick={openContact}>
                            Mark as sold
                        </Button>
                    </Grid>
